...
SRC = {
    ...
    "line-i75":  "exp_putnon_statconn-static-line_1s24h39b_i75/exp_putnon_statconn-static-line_1s24h39b_i75_20210916-203133_ll_pdr_sum.json",
    "line-rand": "exp_putnon_statconn-static-line_1s24h39b_i65r85/exp_putnon_statconn-static-line_1s24h39b_i65r85_20210920-102945_ll_pdr_sum.json",
}
...
class Fig(Expbase):
    ...
    def make(self):
        ...
        ax[0].plot(self.dat["i75"]["data"][0]["x"], self.dat["i75"]["data"][0]["y"], color="C0", label="tree: static connection interval 75ms")
        ax[0].plot(self.dat["rand"]["data"][0]["x"], self.dat["rand"]["data"][0]["y"], color="C1", label="tree: random connection interval [65:85]ms")
        ...
        ax[1].plot(self.dat["line-i75"]["data"][0]["x"], self.dat["line-i75"]["data"][0]["y"], color="C2", label="line: static connection interval 75ms")
        ax[1].plot(self.dat["line-rand"]["data"][0]["x"], self.dat["line-rand"]["data"][0]["y"], color="C3", label="line: random connection interval [65:85]ms")
        ...
        fig.text(0.00, 0.5, 'Link layer PDR [0:1.0]', ha='center', va='center', rotation='vertical', size=AXISLBLSIZE)
